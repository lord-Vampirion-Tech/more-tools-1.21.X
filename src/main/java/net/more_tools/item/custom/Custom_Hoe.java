...
public class Custom_Hoe extends Custom_Pickaxe {
    public Custom_Hoe(ToolMaterial material, float damage, float attackSpeed, TagKey<Block> blocksTag, Settings settings, int range, int deep) {
        super(material, damage, attackSpeed, blocksTag, settings, range, deep);
    }

    public Custom_Hoe(ToolMaterial material, float damage, float attackSpeed, TagKey<Block> blocksTag, Settings settings, int range) {
        this(material, damage, attackSpeed,blocksTag, settings, range, 0);
    }

    public Custom_Hoe(ToolMaterial material, float damage, float attackSpeed, TagKey<Block> blocksTag, Settings settings) {
