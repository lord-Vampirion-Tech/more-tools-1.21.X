...
public class Custom_Axe extends Custom_Pickaxe {
    public Custom_Axe(ToolMaterial material, float damage, float attackSpeed, TagKey<Block> blocksTag, Settings settings, int range, int deep) {
        super(material, damage, attackSpeed, blocksTag, settings, range, deep);
    }

    public Custom_Axe(ToolMaterial material, float damage, float attackSpeed, TagKey<Block> blocksTag, Settings settings, int range) {
        this(material, damage, attackSpeed,blocksTag, settings, range, 0);
    }
    public Custom_Axe(ToolMaterial material, float damage, float attackSpeed, TagKey<Block> blocksTag, Settings settings) {
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        for (BlockPos pos : positions) {
            ...
            if (shouldCancelStripAttempt(context)) {
                ...
                Optional<BlockState> optional = this.tryStrip(world, pos, playerEntity, state);
                if (optional.isEmpty()) {
                } else {
