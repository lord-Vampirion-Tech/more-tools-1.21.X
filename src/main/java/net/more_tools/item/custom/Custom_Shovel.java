...
public class Custom_Shovel extends Custom_Pickaxe {
    public TagKey<Block> tags = BlockTags.PICKAXE_MINEABLE;

    public Custom_Shovel(ToolMaterial material, float damage, float attackSpeed, TagKey<Block> blocksTag, Settings settings, int range, int deep) {
        super(material, damage, attackSpeed,blocksTag, settings, range, deep);
    }

    public Custom_Shovel(ToolMaterial material, float damage, float attackSpeed, TagKey<Block> blocksTag, Settings settings, int range) {
        this(material, damage, attackSpeed,blocksTag, settings, range, 0);
    }

    public Custom_Shovel(ToolMaterial material, float damage, float attackSpeed, TagKey<Block> blocksTag, Settings settings) {
